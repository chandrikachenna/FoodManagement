...
describe('MealReviewInfoModel tests', () => {
   ...
   beforeEach(()=>{
      ...
      mealReviewInfoModel = new MealReviewInfoModel('mealType',mealReviewInfoService,setMealReviewInfoService)
   })
   ...
   it('should test initialize mealReviewInfoModel', () => {
      ...
      expect(mealReviewInfoModel.updateMealReviewInfoResponse).toStrictEqual(new Array())
   })
   ...
   it('should test updateMealReviewInfo fetching state', () => {
      ...
      const mockUpdateMealReviewInfoService = jest.fn().mockReturnValue(mockLoadingPromise)
      setMealReviewInfoService.setMealReviewInfo = mockUpdateMealReviewInfoService
      
      mealReviewInfoModel.setMealReviewInfo()
      expect(mealReviewInfoModel.getUpdateMealReviewAPIStatus).toBe(API_FETCHING)
   })

   it('should test mealReviewInfo success state', async() => {
      const mockLoadingPromise = Promise.resolve(getMealReviewInfo)
      const mockMealReviewInfoService = jest.fn().mockReturnValue(mockLoadingPromise)
   ...
   it('should test updateMealReviewInfo success state', async() => {
      const mockLoadingPromise = Promise.resolve(getUpdateMealReviewInfoResponse)
      const mockUpdateMealReviewInfoService = jest.fn().mockReturnValue(mockLoadingPromise)
      setMealReviewInfoService.setMealReviewInfo = mockUpdateMealReviewInfoService

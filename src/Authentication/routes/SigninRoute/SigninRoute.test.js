...
} from '../../../FoodManagement/constants/RouteConstants';
...
const LocationDisplay = withRouter(({ location }) => (
 ...
 describe('SignInRoute tests',()=>{
    ...
    it("should render signInRoute success state", async () => {
        ...
        const pageNavigation = await waitForElement(() => getByTestId("location-display"));
       ...
       it("should render signInRoute failure state", async() => {
        ...
        const serverError = await waitForElement(() => getByText(/Network Error/i));

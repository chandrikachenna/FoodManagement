...
class MenuDisplayer extends Component {
    ...
    render() {
        ...
        return (
            <>
                <Header>
                    <MenuBar menu={menu} menu1Name={menu1Name} menu2Name={menu2Name} menu3Name={menu3Name} 
                    onClickMenu1={this.onClickMenu1} onClickMenu2={this.onClickMenu2} onClickMenu3={this.onClickMenu3}/>   
                    <DatePicker/>
                </Header>
                {
                    this.selectedMenu &&

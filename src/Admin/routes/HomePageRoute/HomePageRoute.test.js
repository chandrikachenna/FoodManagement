...
describe('HomePageRoute tests',()=>{
    ...
    it('it should test signOut',async()=>{
        ...
        const {
            ...
            <Provider scheduleMealStore={scheduleMealStore} headCountsStore={headCountsStore} authStore={authStore}>
    ...
    it('it should test Home',async()=>{
        ...
        const pageNavigation = await waitFor(() => getByRole("button", { name: "Home" }));
